  ...
  return <nav className="sticky top-0 z-50 border-b border-slate-800 bg-slate-950/80 backdrop-blur">
    <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
      ...
      <div className="hidden gap-5 text-sm md:flex">
        <Link href="/courses">Courses</Link><Link href="/signals">Signals</Link><Link href="/signal-performance">Performance</Link><Link href="/market-tools">Market Tools</Link><Link href="/about">About</Link><Link href="/contact">Contact</Link>
      </div>
